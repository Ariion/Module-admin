...
| **Modèles de section** | Huit mises en page prêtes à l'emploi — trois colonnes, image et texte, appel à l'action, galerie, contact… Elles n'apportent que la structure : la typographie vient du site. |
...
| **Habillage complet** | Couleurs, typographie (taille, graisse, casse, interlignage, espacement), espacements, bordure, ombre — et du **CSS personnalisé** avec sélecteur, pour les états `:hover` par exemple. |
