...
| **Placement libre, à la souris** | Chaque bloc porte une **poignée** : on l'attrape et on le pose où l'on veut dans sa section, avec le décalage affiché pendant le geste (Maj bloque un axe). Largeur, alignement, décalage et rotation restent réglables au pixel près. Le décalage est une transformée, pas une marge : le bloc bouge, la mise en page autour ne bronche pas. |
